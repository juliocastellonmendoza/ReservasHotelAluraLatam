...
//		}
		if(txtTelefono.getText().length()==0) {
			...
			//.showConfirmDialog(rootPane, "Debes ingresar una carácteristica para la habitación");
			txtTelefono.requestFocus();
			return;
		}
//		if(txtNacionalidad.getText().length()==0) {
//			JOptionPane.showMessageDialog(rootPane, "Debes ingresar la nacionalidad del huesped");
//			//.showConfirmDialog(rootPane, "Debes ingresar una carácteristica para la habitación");
//			txtNacionalidad.requestFocus();
//			return;
//		}
//		if(txtNreserva.getText().length()==0) {
//			JOptionPane.showMessageDialog(rootPane, "Debes ingresar el código de reserva del huesped");
//			//.showConfirmDialog(rootPane, "Debes ingresar una carácteristica para la habitación");
//			txtNreserva.requestFocus();
//			return;
//		}
		
		VHuespedes dts = new VHuespedes();
		FHuespedes func = new FHuespedes();
		...
		Calendar cal;
		int d,m,a;
		cal=txtFechaN.getCalendar();
		d=cal.get(Calendar.DAY_OF_MONTH);
		m=cal.get(Calendar.MONTH);
		a=cal.get(Calendar.YEAR)-1900;
		dts.setFecha_de_nacimiento(new Date(a,m,d));
		
		int seleccionado = txtNacionalidad.getSelectedIndex();
		dts.setNacionalidad((String)txtNacionalidad.getItemAt(seleccionado));
		dts.setTelefono(txtTelefono.getText());
		txtNreserva.setText(String.valueOf(dts.getIdreserva()).toString());
		dts.setIdreserva(Integer.parseInt(txtNreserva.getText()));
