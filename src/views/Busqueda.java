...
public class Busqueda extends JFrame {
	...
	int xMouse, yMouse;
	private FHuespedes func;
	private FReservas func1;
	 ...
	 */
	public Busqueda() {
		this.func = new FHuespedes();
		this.func1 = new FReservas();
	...
	public void mostrarHuespedes(String buscar) {
		...
		var productos = this.func.mostrar(buscar);
		
        productos.forEach(producto -> modeloHuesped.addRow(new Object[] { producto.getIdhuespedes(), producto.getNombre(),
            producto.getApellido(),producto.getFecha_de_nacimiento(), producto.getNacionalidad(), producto.getTelefono(),
            producto.getIdreserva() }));	
	}
	...
	public void mostrarReservas(String buscar) {
		...
		var productos = this.func1.mostrar(buscar);
		
        productos.forEach(producto -> modelo.addRow(new Object[] { producto.getIdreserva(), producto.getFecha_entrada(),
        		producto.getFecha_salida(), producto.getValor(), producto.getForma_pago()}));	
	}
	...
	public void editarHuespedes() {
        ...
        .ifPresentOrElse(fila -> {
    		...
    		Date parsed = null;
    		try {
    		    parsed = sdf.parse(modeloHuesped.getValueAt(tbHuespedes.getSelectedRow(), 3).toString());
    		...
    		var filasenviada = func.editar(nombre, apellido, data, nacionalidad, telefono, idreserva, idhuespedes);
            
            
            
            JOptionPane.showMessageDialog(this, String.format("%d item modificado con exito!",filasenviada));
        }, () -> JOptionPane.showMessageDialog(this, "Por favor, elije un item"));
	}
	...
	public void editarReservas() {
        ...
        .ifPresentOrElse(fila -> {
    		...
    		Date parsed = null;
    		try {
    		    parsed = sdf.parse(modelo.getValueAt(tbReservas.getSelectedRow(), 1).toString());
    		} catch (ParseException e1) {
    		    e1.printStackTrace();
    		}
    		java.sql.Date data = new java.sql.Date(parsed.getTime());
    		...
    		Date parsedd = null;
    		try {
    		    parsedd = sdfa.parse(modelo.getValueAt(tbReservas.getSelectedRow(), 2).toString());
    		} catch (ParseException e1) {
    		    e1.printStackTrace();
    		}
    		java.sql.Date dataa = new java.sql.Date(parsedd.getTime());
    		...
    		var filasenviada = func1.editar(data, dataa, valor, forma_pago, idreserva);
	...
	private void eliminarHuedpedes() {
        ...
        Optional.ofNullable(modeloHuesped.getValueAt(tbHuespedes.getSelectedRow(), tbHuespedes.getSelectedColumn()))
                .ifPresentOrElse(fila -> {
                    ...
                    var filasModificadas = this.func.eliminar(idhuespedes);
	...
	private void eliminarReservas() {
        ...
        Optional.ofNullable(modelo.getValueAt(tbReservas.getSelectedRow(), tbReservas.getSelectedColumn()))
                .ifPresentOrElse(fila -> {
                    ...
                    var filasModificadas = this.func1.eliminar(idreserva);
