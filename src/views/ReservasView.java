...
public class ReservasView extends JFrame {
	...
	public ReservasView() {
		...
		public void insertar() {
			...
			Calendar cal;
			int d,m,a;
			cal=txtFechaEntrada.getCalendar();
			d=cal.get(Calendar.DAY_OF_MONTH);
			m=cal.get(Calendar.MONTH);
			a=cal.get(Calendar.YEAR)-1900;
			dts.setFecha_entrada(new Date(a,m,d));
			
			cal=txtFechaSalida.getCalendar();
			d=cal.get(Calendar.DAY_OF_MONTH);
			m=cal.get(Calendar.MONTH);
			a=cal.get(Calendar.YEAR)-1900;
			...
			int seleccionado = txtFormaPago.getSelectedIndex();
			dts.setForma_pago((String)txtFormaPago.getItemAt(seleccionado));
